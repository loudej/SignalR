...
namespace SignalR
{
    ...
    public static class RouteExtensions
    {
        ...
        {
            return routes.MapOwinRoute(name, url, builder => builder.UsePersistentConnection<T>());
        ...
        {
            return routes.MapOwinRoute(name, url, builder => builder.UsePersistentConnection<T>(resolver));
        ...
        {
            return routes.MapOwinRoute(name, url, builder => builder.UsePersistentConnection(type));
        ...
        {
            return routes.MapOwinRoute("/signalr", builder => builder.UseHubDispatcher());
        ...
        {
            return routes.MapOwinRoute("/signalr", builder => builder.UseHubDispatcher(resolver));
        ...
        {
            return routes.MapOwinRoute(url, builder => builder.UseHubDispatcher());
